...
class UserCollection {
   ...
   */
  static async addOne(username: string, password: string, anon: boolean): Promise<HydratedDocument<User>> {
    const dateJoined = new Date();

    const user = new UserModel({username, password, dateJoined, anon});
